...
async function aggregateResults() {
    ...
    console.log(colors.cyan('═'.repeat(100)) + '\n');
    console.log(colors.bold('  #  | Strategy      | Best ROI  | Best Win% | Best P&L   | Avg ROI   | Profitable | Files'));
    ...
    strategies.slice(0, 15).forEach((s, i) => {
        ...
        console.log(`  ${colors.yellow((i + 1).toString().padEnd(2))} | ` +
    ...
    const topTraders = Array.from(allTraders.entries())
        ...
        .slice(0, 10);
    console.log(colors.bold('  #  | Address                                    | Best ROI  | Best Strategy | Found times'));
    console.log(colors.gray('─'.repeat(100)));
    ...
    console.log(`  Profitable traders:      ${colors.green(totalProfitable.toString())} (${profitableRate.toFixed(1)}%)`);
    // Best strategy
