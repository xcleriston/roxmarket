...
const checkMyStats = async () => {
    ...
    try {
        ...
        if (positions && positions.length > 0) {
            ...
            console.log(`   📈 Unrealized P&L: $${totalUnrealizedPnl.toFixed(2)} (${((totalUnrealizedPnl / totalInitialValue) * 100).toFixed(2)}%)`);
        ...
        if (positions && positions.length > 0) {
            ...
            console.log(`      → $${totalUnrealizedPnl.toFixed(2)} ← THIS is NOT displayed on the chart\n`);
