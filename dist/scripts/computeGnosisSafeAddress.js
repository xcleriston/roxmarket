                        ...
                        try {
                            ...
                            if (owners && owners.length > 0) {
                                ...
                                if (isOwner) {
                                    ...
                                    // Check positions
                                    const positions = await fetchData(`https://data-api.polymarket.com/positions?user=${proxyAddress}`);
    ...
    try {
        ...
        if (isContract) {
            ...
            try {
                ...
                // Check positions
                const positions = await fetchData(`https://data-api.polymarket.com/positions?user=${suspectAddress}`);
